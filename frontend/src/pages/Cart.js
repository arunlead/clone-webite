import React, { useState } from 'react';
 ...
 export default function Cart({ cartItems, setCartItems }) {
    ...
    const addItemToCart = (product) => {
        const newCartItem = {
            id: uuid(), // Use a unique identifier for the new item
            product: product,
            price: product.price,
    ...
    return ( cartItems.length > 0 ?
      <Fragment> <div className="container container-fluid">
            <h2 className="mt-5">Your Cart: <b>{cartItems && cartItems.length} items</b></h2>
        ...
        <Fragment><h2 className='mt-5'>Order Complete!</h2><p>Your order is placed successfully!</p></Fragment>)
    );
      }
